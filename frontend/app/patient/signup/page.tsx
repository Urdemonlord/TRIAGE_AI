    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 to-primary-100 px-4 py-12">
      <div className="max-w-md mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">Daftar Sebagai Pasien</p>
        </div>

        {/* Signup Card */}
        <div className="card shadow-lg">
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Buat Akun Pasien</h1>
          <p className="text-gray-600 mb-6 text-sm">Mulai periksa kesehatan Anda</p>
          ...
          <div className="mt-6 text-center text-sm">
            <p className="text-gray-600">
              Sudah punya akun?{' '}
              <Link href="/patient/login" className="text-primary-600 hover:text-primary-700 font-medium">
                Masuk di sini
              </Link>
            </p>
          </div>
