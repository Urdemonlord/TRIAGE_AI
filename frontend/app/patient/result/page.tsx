        ...
        <div className={`card mb-8 bg-${urgencyColor}-50 border-2 border-${urgencyColor}-200`}>
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1">
              ...
              {/* Emergency Button - Only for Red Urgency */}
              {result.urgency.urgency_level === 'Red' && (
                <a
                  href="https://simpus.meowlabs.id/emergency"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="mt-6 inline-block w-full bg-danger-600 hover:bg-danger-700 text-white font-bold py-4 px-6 rounded-lg text-center shadow-lg transition-all duration-200 transform hover:scale-105"
                >
                  <div className="flex items-center justify-center space-x-3">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
                    </svg>
                    <span className="text-xl">🚨 SEGERA KE IGD</span>
                  </div>
                  <p className="text-sm mt-2 font-normal opacity-90">
                    Klik untuk mendaftar ke layanan IGD
                  </p>
                </a>
              )}
            </div>
