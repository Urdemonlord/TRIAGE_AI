    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 to-primary-100 flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">Portal Dokter</p>
        </div>

        {/* Login Card */}
        <div className="card shadow-lg">
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Masuk Sebagai Dokter</h1>
          <p className="text-gray-600 mb-6">Akses dashboard untuk review triage pasien</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {/* Email Field */}
            <div>
              <label className="label">Email Dokter</label>
              <input
                type="email"
                value={email}
            ...
            <div className="flex items-center justify-between text-sm">
              ...
              <Link href="/doctor/forgot-password" className="text-primary-600 hover:text-primary-700">
                Lupa password?
              </Link>
            </div>
        ...
        <div className="mt-8 text-center text-sm text-gray-600">
          <p className="mb-4">
            Bukan dokter?{' '}
            <Link href="/patient/check" className="text-primary-600 hover:text-primary-700 font-medium">
              Cek gejala sebagai pasien
            </Link>
          </p>
          <p>
            Butuh bantuan?{' '}
